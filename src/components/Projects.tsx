...
//         <h1 className=" text-5xl text-cyan-400 font-bold pt-8">
//           Featured Projects
//         </h1>
...
//               is a react application demonstrates user authentication using
//               Appwrite ans TypeScript. This project having features like User
//               login, User Signup, profile management.
//             </CardItem>
...
//               className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300"
//             >
//               An application that allows us to fetch user's details who uses
//               GitHub, and for this, useState and useEffect hooks have been used.
//               This Project display the users details like name, bio, repository
//               name, its live link and description.
//             </CardItem>
...
//         <Button  className="text-[#a9ff47] text-lg font-semibold bg-transparent w-[20rem] border-[1px] border-[#a9ff47] hover:bg-[#a9ff47] hover:text-black mb-8">
